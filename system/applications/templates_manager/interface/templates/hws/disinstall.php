	...
	<section>
		<article>
			...
			<form action="system/tools/disinstall.php" method="post">
				<h5>Disinstall a template</h5>
				Are you sure that you want to disinstall <b><?php echo($_GET['name']); ?></b> ?<br>
				<p class="chip"><a href="index.php">No</a></p>
				<input type="hidden" name="template_name" value="<?php echo($_GET['name']); ?>">
