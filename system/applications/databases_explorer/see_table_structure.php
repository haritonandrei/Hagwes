...
else
{
	...
	if( has_permission("see_reserved_data", $website_name, $permissions) )
	{
		...
		$records = get_database_table_structure_array($_GET['table'], $server_name, $username, $password, $_GET['database'], $tables_prefix);
	
		// TEMPLATE
		require("interface/templates/".$template_applications."/see_table_structure.php");
	}
	else
	{
