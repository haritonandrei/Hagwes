...
<body>	
	...
	<section>
		<article>
			...
			<aside>
				<h5>Structure of "<?php echo($_GET['database']); ?> &raquo; <?php echo($_GET['table']); ?>"</h5>
				<p class="chip"><a href="see_database_tables.php?database=<?php echo($_GET['database']); ?>">Return to database</a></p>
				<p class="chip"><a href="see_table_records.php?database=<?php echo($_GET['database']); ?>&&table=<?php echo($_GET['table']); ?>">See records</a></p>
			</aside>
